...
//                Toast.makeText(ChatRooms.this, ((TextView)view).getText().toString(), Toast.LENGTH_SHORT).show();
...
//                Snackbar.make(getWindow().getDecorView().getRootView(), "Chat Room Added", Snackbar.LENGTH_LONG).show();
            }
